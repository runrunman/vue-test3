      ...
      <div class="loginInner">
        <div class="login_header">
          ...
          <div class="login_header_title">
            <a href="javascript:;" @click="isPassWordLogin = false " :class="{on: !isPassWordLogin}">短信登录</a>
            <a href="javascript:;" @click="isPassWordLogin = true" :class="{on:isPassWordLogin}">密码登录</a>
          </div>
        </div>
          ...
          <form>
            <div :class="{on:!isPassWordLogin}">
              <section class="login_message">
                ...
                <button @click.prevent="sendCode" :disabled="!isRightPhoneNumber || !!countDown" class="get_verification"
            ...
            <div :class="{on:isPassWordLogin}"> 
              <section>
                ...
                <section class="login_verification">
                  <input v-model="pwd" v-validate="'required'" :type="isShowPassword?'tel':'password'" maxlength="8" placeholder="密码" name="pwd">
